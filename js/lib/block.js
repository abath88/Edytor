...
class BlockText {
  ...
  deleteNodes(startNodeKey, endNodeKey) {
        let startNode = this.nodes.getNodeByKey(startNodeKey);
        let endNode = this.nodes.getNodeByKey(endNodeKey);

        let currNode = startNode != endNode ? startNode.next : startNode;
